package com.sunmi.doublescreen.doublescreenapp.boolkeyprint;
...
//        tsc.addCls();// 清除打印缓冲区
//        // 绘制简体中文
//        tsc.addText(20, 10, FONTTYPE.SIMPLIFIED_CHINESE, ROTATION.ROTATION_0, FONTMUL.MUL_1, FONTMUL.MUL_1,
//                "001 珍珠奶茶 冰 中杯");
////        // 绘制图片
////        Bitmap b = BitmapFactory.decodeResource(getResources(), R.drawable.gprinter);
////        tsc.addBitmap(20, 50, BITMAP_MODE.OVERWRITE, b.getWidth(), b);
//
//        tsc.addQRCode(10, 40, EEC.LEVEL_L, 5, ROTATION.ROTATION_0, " www.smarnet.cc");
//        // 绘制一维条码
